...
REM
REM Generated by Vivado on Sat Feb 21 11:25:49 +0530 2026
...
echo "xvlog --incr --relax -prj ahb_top_tb_vlog.prj"
call xvlog  --incr --relax -prj ahb_top_tb_vlog.prj -log xvlog.log
